...
def download_inaturalist(taxon_id, save_dir: Path, class_name: str,
                         web_root: Path, n: int = 200, place_id: int = SWEDEN):
...
print("── bumblebee ─────────────────────────────────────────────")
download_inaturalist(TAXON_BOMBUS, _dest("bumblebee"), "bumblebee", WEB_ROOT, n=1000, place_id=SWEDEN)
download_inaturalist(TAXON_BOMBUS, _dest("bumblebee"), "bumblebee", WEB_ROOT, n=1000, place_id=NORWAY)

# ── Fly (Diptera) ─────────────────────────────────────────────────────────
print("── fly ───────────────────────────────────────────────────")
download_inaturalist(TAXON_DIPTERA, _dest("fly"), "fly", WEB_ROOT, n=600, place_id=SWEDEN)
download_inaturalist(TAXON_DIPTERA, _dest("fly"), "fly", WEB_ROOT, n=600, place_id=NORWAY)

# ── Butterfly/moth (Lepidoptera) ──────────────────────────────────────────
print("── butterfly ─────────────────────────────────────────────")
download_inaturalist(TAXON_LEPIDOPTERA, _dest("butterfly"), "butterfly", WEB_ROOT, n=1000, place_id=SWEDEN)
download_inaturalist(TAXON_LEPIDOPTERA, _dest("butterfly"), "butterfly", WEB_ROOT, n=1000, place_id=NORWAY)

# ── Other (beetles + wasps + true bugs) ──────────────────────────────────
# Hymenoptera here = wasps/ants; Bombus is handled separately above (no overlap).
print("── other ─────────────────────────────────────────────────")
download_inaturalist(TAXON_COLEOPTERA,  _dest("other"), "other", WEB_ROOT, n=500, place_id=SWEDEN)
download_inaturalist(TAXON_COLEOPTERA,  _dest("other"), "other", WEB_ROOT, n=500, place_id=NORWAY)
download_inaturalist(TAXON_HYMENOPTERA, _dest("other"), "other", WEB_ROOT, n=500, place_id=SWEDEN)
download_inaturalist(TAXON_HYMENOPTERA, _dest("other"), "other", WEB_ROOT, n=500, place_id=NORWAY)
download_inaturalist(TAXON_HEMIPTERA,   _dest("other"), "other", WEB_ROOT, n=500, place_id=SWEDEN)
download_inaturalist(TAXON_HEMIPTERA,   _dest("other"), "other", WEB_ROOT, n=500, place_id=NORWAY)
